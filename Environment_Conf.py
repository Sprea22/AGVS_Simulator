...
def envir_configuration(width, height):
    ...
    # Set the matrix value to 0.01 if it's a OFFICE
    for x in office_x:
        for y in office_y:
            envir[y,x] = 0.01
    ...
    # Set CHARGING LOCATION in the environment
    charging_x = [42]*48
    charging_y = range(0,48)
    ...
    return envir, wall_x, wall_y, gate_x, gate_y, office_x, office_y, charging_y, charging_x
